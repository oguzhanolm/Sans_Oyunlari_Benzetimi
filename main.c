...
int sansoyunlari()
{
    ...
    if (secim2<1 || secim2>5) {printf("\t\t------------Lutfen Gecerli Bir Islem Numarasi Giriniz!------------\n\n"); goto etiket1;}
            switch(secim2)
            {
                case 1: sayisalloto();              /*Sayýsal Loto  */ break;
                case 2: sanstopu();                 /*Sans Topu     */ break;
                case 3: onnumara();                 /*On Numara     */ break;
                case 4: superloto();                /*Süper Loto    */ break;
...
int sayisalloto()
{
 ...
 temizle;
 printf("______________________________________________________________________________________________________\n");
    printf("^^^^^Sayisal Loto Oyununa Hosgeldiniz^^^^\n\n-------------------------------------------------------\nOyunun Kurallari: Kullanici yeni bir oyun icin [1-49] araliginda 6 farklý sayi girmelidir.\n");
...
int sanstopu()
{
 ...
 temizle;
 printf("______________________________________________________________________________________________________\n");
    printf("^^^^^Sans Topu Oyununa Hosgeldiniz^^^^\n\n-------------------------------------------------------\nOyunun Kurallari: Kullanici yeni bir oyun icin [1-34] araliginda 5 farklý sayi, [1-14] araliginda 1 sayi girmelidir.\n");
    printf("Girilen sayilar ile bilgisayarin olusturdugu sayilar karsilastirilip tutan sayiya gore puan kazanacaktir.\n");
    printf("-------------------------------------------------------\n\n");
        srand(time(NULL));
        for(i=0;i<5;i++)
...
temizle;
 printf("______________________________________________________________________________________________________\n");
    printf("^^^^^Sayisal Loto Oyununa Hosgeldiniz^^^^\n\n-------------------------------------------------------\nOyunun Kurallari: Kullanici yeni bir oyun icin [1-80] araliginda 10 farklý sayi girmelidir.\n");
    printf("Girilen sayilar ile bilgisayarin olusturdugu sayilar karsilastirilip tutan sayiya gore puan kazanacaktir.\n");
    printf("-------------------------------------------------------\n\n");
        srand(time(NULL));
        for(i=0;i<10;i++)
...
int superloto()
{
 ...
 temizle;
 printf("______________________________________________________________________________________________________\n");
    printf("^^^^^Super Loto Oyununa Hosgeldiniz^^^^\n\n-------------------------------------------------------\nOyunun Kurallari: Kullanici yeni bir oyun icin [1-54] araliginda 6 farklý sayi girmelidir.\n");
    printf("Girilen sayilar ile bilgisayarin olusturdugu sayilar karsilastirilip tutan sayiya gore puan kazanacaktir.\n");
    printf("-------------------------------------------------------\n\n");
        srand(time(NULL));
        for(i=0;i<6;i++)
...
//-------------------------ISTATISTIK FONKSIYONU-------------------------| YAPILAMADI
int istatistik(int verial[][10];)
{
    int verial[1000][10];
    int i,j;
    int veriisle[1000][10];
    for (i=0;i<1000;i++) {for (j=0;j<10;j++) {verial[i][j]=veriisle[i][j];}}
     temizle;
int secim;
printf("1-Sayisal Loto\n2-Sans Topu\n3-On Numara\n4-Super Loto"); scanf("%d",&secim);
     switch(secim)
     {
     case 1: superlotoist(veriisle); break;
     }

}

void verialici(int verial[][10])
{
void iş
}


//-------------------------EN COK CIKAN BULMA FONKSIYONU-----------------| YAPILAMADI
void superlotoist(int tutandizi[][100])
{
printf("\n\n\t\t***Super Loto Istatistikler***\n-------------------------------------------------------\n");
int i,j,m;
int sayac[1000];
int ayni[1000][10];
